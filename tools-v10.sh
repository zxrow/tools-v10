...
echo $i" |"$me"─────────────────────────────────────────────******"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Lao'neis agung  [MTS ALHIDAYAH]"$i"         |"
echo $i" |"$pu" FACEBOOK :"$ku" Lao'neis agung"$i" |"
echo $i" |"$pu" THANKS TO :"$cy"~ [Lao'neis agung]"$i"                  |"
echo $i" |"$cy"            ~ [NET CYBER TEAM]"$i"                |"
echo $i" |"$pu" Contack WhatsApp :"$ku" +6289655478810"$i"                 |"
echo $i" |"$pu" Contack Gmail :"$ku" agunggebang1@gmail.com"$i"              |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────******"$i"["$bi"•"$i"]"
echo $bi "■■■■■■■■■■■■■■■■■■■■■■■■■•ೋೋ•■■■■■■■■■■■■■■■■■■■■■■■■■■"
echo $i  "  Penulis        : Lao'neis agung"
echo $i  "  Whatsapp       : +6289655478810"
echo $i  "  Team        : NET CYBER TEAM"
echo $i  "   Facebook : Lao'neis agung"
echo $bi "■■■■■■■■■■■■■■■■■■■■■■■■■•ೋೋ•■■■■■■■■■■■■■■■■■■■■■■■■■■"
...
echo "NAMA CHAENEL : HACKER ONLINE"
echo "SUPPORT : Lao'neis agung"
echo "TEMAN : bayyu & m basari"
figlet "SUBCRIBE"
echo $bi"■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■"
...
echo $i"WhatsApp :"$i" +6289655478810"
echo $bi"Facebook :"$i" Lao'neis agung"
echo $i"Youtube  :"$cy"Hacker online"
exit
fi
